...
insert into permissions_access(permissions_names_id, company_id, action_id) values (1,3,1);
insert into permissions_access(permissions_names_id, company_id, action_id) values (2,3,1);
...
(1, 'shodiyev fayzulloh', '998912007435', '998993646891', 'birnima13', 'bradsfdvd', 30, 3),
(3, 'ilhomov ikrom', '998912004141', '998910511242', 'hakjsldjvhkbnkljdoudisfahsdj', 'bradsfdvd', 30, 3),
(2, 'abdusattorov abdusattor', '998911949145', '998991758191', 'fvjfaskndmvkjouhsdadjsndkms', 'bradsfdvd', 30, 3),
(3, 'valiyev anasxon', '998941384819', '998991849105', 'fjshakndlskdpsiodjadnlk;svfoivo', 'bradsfdvd', 30, 3),
